...
% l.f_sI_xc = 0.1; % - 
% l.f_xI_xc = 0.2; % - 
% l.f_ch_xc = 0.2; % -  %% aus ADM Publikation
% l.f_pr_xc = 0.25; % - 
% l.f_li_xc = 0.25; % - 

% l.f_sI_xc = 0.1; % - 
% l.f_xI_xc = 0.2; % - 
% l.f_ch_xc = 0.2; % -  %% aus Masterarbeit
% l.f_pr_xc = 0.2; % - 
% l.f_li_xc = 0.3; % - 

%% ge‰ndert, neue Daten aus Aetal 2012
% l.N_xc = 0.028/14; %kmole N (kg COD)^-1  % ge‰ndert %% aus ADM Pub
% l.N_I = 0.028/14; %kmole N (kg COD)^-1   % ge‰ndert
...
% l.C_xc = 0.03; %kmole C (kg COD)^-1 % ge‰ndert
...
%%
% l.N_bac = 0.0875/14; %kmole N (kg COD)^-1  % ge‰ndert
...
%........................................... 
l.K_S_p_caco3 = exp(-0.01183*l.T_op-8.03)/0.665^2; %kg CaCO3 m^?3 (equilibrium constant)
...
l.S_va_in = 0.548; %kg COD m^?3 4 
l.S_bu_in = 1.148; %kg COD m^?3 5 
l.S_pro_in = 2.045; %kg COD m^?3 6 
l.S_ac_in = 5.566; %kg COD m^?3 7 
...
%% ge‰ndert am 30.12.2019 zum Test, ob fehlender Bakterieneinstrom Dilutionsoptimum verschiebt
l.X_xc_in = 0.5; %kg COD m^?3 13 
l.X_ch_in = 13.94; %kg COD m^?3 14
l.X_pr_in = 18.11; %kg COD m^?3 15
l.X_li_in = 7.49; %kg COD m^?3 16 
l.X_su_in = 0.6; %kg COD m^?3 17 
l.X_aa_in = 0.6; %kg COD m^?3 18 
l.X_fa_in = 0.6; %kg COD m^?3 19 
l.X_c4_in = 0.6; %kg COD m^?3 20 
l.X_pro_in = 0.6; %kg COD m^?3 21 
l.X_ac_in = 0.018; %kg COD m^?3 22 
l.X_h2_in = 0.018; %kg COD m^?3 23 
l.X_I_in = 25.0; %kg COD m^?3 24 

%% Annahme, dass einflieﬂendes Substrat steril ist
% l.X_xc_in = 0; %kg COD m^?3 13 
% l.X_ch_in = 0; %kg COD m^?3 14
% l.X_pr_in = 0; %kg COD m^?3 15
% l.X_li_in = 0; %kg COD m^?3 16 
% l.X_su_in = 0; %kg COD m^?3 17 
% l.X_aa_in = 0; %kg COD m^?3 18 
% l.X_fa_in = 0; %kg COD m^?3 19 
% l.X_c4_in = 0; %kg COD m^?3 20 
% l.X_pro_in = 0; %kg COD m^?3 21 
% l.X_ac_in = 0; %kg COD m^?3 22 
% l.X_h2_in = 0; %kg COD m^?3 23 
% l.X_I_in = 0; %kg COD m^?3 24 

%................................................. 
l.S_cat_in = 0.04; %kmole m^?3 25 
l.S_an_in = 0.075; %kmole m^?3 26 
%................................................. 
%%
l.q_in = 170; %m^3 d^-1 Standardwert!!! 
%%
% l.q_in = 640;
